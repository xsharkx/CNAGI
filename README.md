...
事务ID|2Byte|通用卡头扩展盒专用
实物币数量|4Byte|通用卡头扩展盒专用
干扰检测|1Byte|无干扰:0x00    检测到干扰:0x01
...
事务ID|2Byte|
实物币数量|4Byte|
干扰标志位|1Byte|无干扰:0x01   检测到干扰:0x00


<A NAME="P12_2"></A>

### **12.2 设置投币输出、彩票使能、彩票光眼电平(PID=0x0502)**
---

数据方向:外接设备->游戏机

说明：设置投币输出、彩票使能、彩票光眼电平

游戏机发送内容（DATA）如下:

发送参数|长度|说明
---|---|---
投币输出|1Byte|高:0x01   低:0x00
彩票使能|1Byte|高:0x01   低:0x00
彩票光眼|1Byte|高:0x01   低:0x00
...
应答参数|长度|说明
---|---|---
回复结果|1Byte|成功:0x01   失败:0x00



<A NAME="P12_3"></A>

### **12.3 设置退票、退币额度(PID=0x0503)**
---
...
---|---|---
事务ID|2Byte|
出票状态|1Byte|空闲:0x00   出票中:0x01    出票结束:0x02
电子票|4Byte|
实物票|4Byte|
电子币|4Byte|
实物币|4Byte|
干扰标志|1Byte|无干扰:0x00   检测干扰:0x01
...
应答参数|长度|说明
---|---|---
操作结果|2Byte|成功:0x0001 校验失败:0x0002 硬件版本错误:0x0003 固件版本错误:0x0004 板子类型错误:0x0005 更新完成:0x0006
下次偏移量|4Byte|
...
油菜花|0001|通用扩展板|0x00010003|通用扩展板|
