...
欢迎行业各位大神加入到此协议的完善与优化，有意加入维护的行业技术人员可通过自行Fork代码提交自己的更新。或者微信联系13025128215杨生进行接口优化探讨。另外如有疑问也可在Github里进行探讨。https://github.com/xsharkx/CNGPI

也希望广大厂商加入此项目将自己的产品录入进来，或者联系17702043650杨生进行登记，登记需要如下信息：厂商名，产品名，产品内部编码，产品图片（正面照一张800X600像素，侧45度一张800X600像素）,长，宽，高（cm），设备类型（纯玩机,彩票机,娃娃机,扭蛋机，口红机,福袋机）
...
应答参数|长度|说明
---|---|---
协议版本|4Byte|当前使用的本协议版本如：118，100=V1.0，101=V1.01.需要外接设备根据此数来适配不同版本的协议，当前版本说明一般注明在文档第四章
...
菜单项说明长度|1Byte|菜单项说明占用字节长度,不能超过200
...
说明：用于远程菜单设置时读取游戏机可设置的菜单项,所有菜单项不能超过100个,否则视为无效
