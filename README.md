...
说明：此场景用于礼品机支付时云端服务对其进行概率干预时使用，超时处理同8.2，游戏机记录此投币码表时都计算成电子币，每500ms一次的频率发送10次直到有回应，无回应会退款，一次通讯局数不要超过100，如果超过请通过多次通讯进行传递。建议总局数不要超过500，以免游戏机存储空间不足
...
蓝迪科技|0004|口红挑战|khtz01|00040001|游戏售货机|[详情](Device/0004/00040001/README.md)
