...
说明：用于外接设备在检测到异常（干扰）或故障率偏高或被设置为停用时让游戏机不能工作，直到被此指令恢复，如游戏机能控制投币器投币可禁用投币器使其不接受投实物币
...
厂商|厂商编号|产品|内部编号|统一编号|设备类型|详情
---|---|---|---|---|---|---
谷微动漫|0003|超级抓神|gw_whwwj|0001|礼品机|[详情](Device/0003/00030001/README.md)
...
厂商|厂商编号|产品|内部编号|统一编号|设备类型|详情
---|---|---|---|---|---|---
油菜花|0001|芸苔盒子V1|ythzv1|0001|支付盒子|[详情](Device/0001/00010001/README.md)
