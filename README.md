...
- 游戏机与数据采集设备进行数据交换与监控
## 二 版权声明
本协议由游戏机行业共同发起，共同维护，完全公开。欢迎行业各厂商加入此协议的共同修订贡献力量
## 三 摘要
...
单机中奖率设置|2Byte|0~FFFF（没有可不使用）几币出礼品
...
油菜花|00001|芸苔盒子V2|0002||内置于游戏机机内实现正扫支付，反扫支付，数据采集的设备|链接
油菜花|00001|反扫卡头V2|0003|外装于游戏机表面实现正扫支付，反扫支付，数据采集的设备|链接
华熙动漫|00002|两爪机|0001|娃娃机|链接
谷微动漫|00003|xx机|0001|娃娃机|链接
